...
import { CastMemberModel, CastMemberSequelizeRepository } from '@core/cast-member/infra/db/sequelize/cast-member-sequelize.repository';
...
export const USE_CASES = {
    CREATE_CAST_MEMBER_USE_CASE: {
        ...
        useFactory: (castMemberRepo: CastMemberRepository) => {
